...
class TrendsErrorResponse(BaseModel):
    """
    TrendsErrorResponse
    """ # noqa: E501
    error: TrendsErrorResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": TrendsErrorResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
