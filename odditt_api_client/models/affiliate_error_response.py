...
class AffiliateErrorResponse(BaseModel):
    """
    AffiliateErrorResponse
    """ # noqa: E501
    error: AffiliateErrorResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": AffiliateErrorResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
