...
class AuthCreateSecretResponse(BaseModel):
    """
    AuthCreateSecretResponse
    """ # noqa: E501
    client_secret: Optional[StrictStr] = Field(default=None, description="Plaintext secret (returned only once, prefixed with betflow_b2b_)")
