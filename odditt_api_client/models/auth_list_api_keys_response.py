...
class AuthListAPIKeysResponse(BaseModel):
    """
    AuthListAPIKeysResponse
    """ # noqa: E501
    api_keys: Optional[List[AuthListAPIKeysResponseApiKeysInner]] = None
    success: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["api_keys", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "api_keys": [AuthListAPIKeysResponseApiKeysInner.from_dict(_item) for _item in obj["api_keys"]] if obj.get("api_keys") is not None else None,
