...
class AuthListSecretsResponse(BaseModel):
    """
    AuthListSecretsResponse
    """ # noqa: E501
    secrets: Optional[List[AuthListSecretsResponseSecretsInner]] = None
    success: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["secrets", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "secrets": [AuthListSecretsResponseSecretsInner.from_dict(_item) for _item in obj["secrets"]] if obj.get("secrets") is not None else None,
