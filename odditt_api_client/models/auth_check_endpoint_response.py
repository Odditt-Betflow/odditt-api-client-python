...
class AuthCheckEndpointResponse(BaseModel):
    """
    AuthCheckEndpointResponse
    """ # noqa: E501
    data: Optional[AuthCheckEndpointResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AuthCheckEndpointResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
