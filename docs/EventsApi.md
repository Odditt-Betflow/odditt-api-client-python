...
with odditt_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = odditt_api_client.EventsApi(api_client)
    v1_events_upcoming_events_post_request = {"event_date":"2026-04-09","league_id":null,"page":1,"page_size":20,"sport_id":2,"timezone":"UTC"} # V1EventsUpcomingEventsPostRequest | 

    try:
        # Get upcoming events
        api_response = api_instance.v1_events_upcoming_events_post(v1_events_upcoming_events_post_request)
        print("The response of EventsApi->v1_events_upcoming_events_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EventsApi->v1_events_upcoming_events_post: %s\n" % e)
```
