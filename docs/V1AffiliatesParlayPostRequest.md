...
**event_betting_market_position_ids** | **List[int]** | The event betting market positions that make up the parlay legs. | 
...
json = "{}"
# create an instance of V1AffiliatesParlayPostRequest from a JSON string
v1_affiliates_parlay_post_request_instance = V1AffiliatesParlayPostRequest.from_json(json)
# print the JSON string representation of the object
print(V1AffiliatesParlayPostRequest.to_json())

# convert the object into a dict
v1_affiliates_parlay_post_request_dict = v1_affiliates_parlay_post_request_instance.to_dict()
# create an instance of V1AffiliatesParlayPostRequest from a dict
v1_affiliates_parlay_post_request_from_dict = V1AffiliatesParlayPostRequest.from_dict(v1_affiliates_parlay_post_request_dict)
```
